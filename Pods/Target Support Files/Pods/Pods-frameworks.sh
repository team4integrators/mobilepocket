...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/AWSCognitoIdentityProvider.framework"
  ...
  install_framework "Pods/FZAccordionTableView.framework"
  ...
  install_framework "Pods/Segmentio.framework"
